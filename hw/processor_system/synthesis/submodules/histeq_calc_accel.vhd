...
entity acc_linear_function is
	port (
		...
		avs_params_writedata   : in  std_logic_vector(31 downto 0)  := (others => '0'); --       .writedata
		...
		aso_out_data           : out std_logic_vector(31 downto 0);                    --    out.data
...
architecture rtl of acc_linear_function is
	signal a_reg : std_logic_vector(31 downto 0); --pixel counter
...
--	end process;
	...
	aso_out_data <= std_logic_vector(to_unsigned(ram_memory(pixel_cnt),32));
