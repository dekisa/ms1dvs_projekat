...
module processor_system_mm_interconnect_0 (
	...
	wire  [103:0] performance_counter_0_control_slave_agent_rf_source_data;                           // performance_counter_0_control_slave_agent:rf_source_data -> performance_counter_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] performance_counter_0_control_slave_agent_rsp_fifo_out_data;                        // performance_counter_0_control_slave_agent_rsp_fifo:out_data -> performance_counter_0_control_slave_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> performance_counter_0_control_slave_agent:cp_data
	...
	wire   [26:0] pll_pll_slave_agent_m0_address;                                                     // pll_pll_slave_agent:m0_address -> pll_pll_slave_translator:uav_address
	...
	wire  [103:0] pll_pll_slave_agent_rf_source_data;                                                 // pll_pll_slave_agent:rf_source_data -> pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] pll_pll_slave_agent_rsp_fifo_out_data;                                              // pll_pll_slave_agent_rsp_fifo:out_data -> pll_pll_slave_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pll_pll_slave_agent:cp_data
	...
	wire  [102:0] performance_counter_0_control_slave_agent_rp_data;                                  // performance_counter_0_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [102:0] pll_pll_slave_agent_rp_data;                                                        // pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire    [4:0] router_006_src_channel;                                                             // router_006:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [4:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [4:0] sdram_s1_cmd_width_adapter_src_channel;                                             // sdram_s1_cmd_width_adapter:out_channel -> sdram_s1_burst_adapter:sink0_channel
	...
	wire  [102:0] cmd_demux_src3_data;                                                                // cmd_demux:src3_data -> crosser:in_data
	...
	wire  [102:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_003:sink0_data
	...
	wire  [102:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_001:in_data
	wire          rsp_demux_003_src0_ready;                                                           // crosser_001:in_ready -> rsp_demux_003:src0_ready
	wire    [4:0] rsp_demux_003_src0_channel;                                                         // rsp_demux_003:src0_channel -> crosser_001:in_channel
	...
	wire  [102:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink3_data
	wire          crosser_001_out_ready;                                                              // rsp_mux:sink3_ready -> crosser_001:out_ready
	wire    [4:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink3_channel
	...
	processor_system_mm_interconnect_0_router_002 router_003 (
	...
	processor_system_mm_interconnect_0_router_004 router_004 (
	...
	processor_system_mm_interconnect_0_router_002 router_005 (
	...
	processor_system_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_c0_clk),                                     //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (pll_c0_clk),                                     //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_c0_clk),                                     //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (pll_c0_clk),                                     //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
