...
module processor_system_mm_interconnect_0 (
	...
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> pll_pll_slave_agent:cp_valid
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> pll_pll_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // pll_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> pll_pll_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> pll_pll_slave_agent:cp_endofpacket
	...
	wire          pll_pll_slave_agent_rp_valid;                                                       // pll_pll_slave_agent:rp_valid -> router_004:sink_valid
	wire  [101:0] pll_pll_slave_agent_rp_data;                                                        // pll_pll_slave_agent:rp_data -> router_004:sink_data
	wire          pll_pll_slave_agent_rp_ready;                                                       // router_004:sink_ready -> pll_pll_slave_agent:rp_ready
	wire          pll_pll_slave_agent_rp_startofpacket;                                               // pll_pll_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          pll_pll_slave_agent_rp_endofpacket;                                                 // pll_pll_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire   [83:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [83:0] router_005_src_data;                                                                // router_005:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                               // sdram_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [3:0] router_005_src_channel;                                                             // router_005:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [101:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                               // rsp_demux_003:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire    [3:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire  [101:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                              // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire  [101:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_002:sink0_data
	...
	wire  [101:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> crosser_001:in_data
	wire          rsp_demux_002_src0_ready;                                                           // crosser_001:in_ready -> rsp_demux_002:src0_ready
	wire    [3:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_001:in_channel
	...
	wire  [101:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink2_data
	wire          crosser_001_out_ready;                                                              // rsp_mux:sink2_ready -> crosser_001:out_ready
	wire    [3:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink2_channel
	...
	wire          pll_pll_slave_agent_rdata_fifo_out_valid;                                           // pll_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pll_pll_slave_agent_rdata_fifo_out_data;                                            // pll_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          pll_pll_slave_agent_rdata_fifo_out_ready;                                           // avalon_st_adapter_002:in_0_ready -> pll_pll_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> pll_pll_slave_agent:rdata_fifo_sink_error
	...
	processor_system_mm_interconnect_0_router_002 router_002 (
	...
	processor_system_mm_interconnect_0_router_003 router_003 (
	...
	processor_system_mm_interconnect_0_router_002 router_004 (
	...
	processor_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_c0_clk),                                     //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (pll_c0_clk),                                     //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_c0_clk),                                     //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_system_mm_interconnect_0_avalon_st_adapter_003 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
